...
Route::prefix('/account')->middleware(AccountSubject::class)->group(function () {
    ...
    Route::put('/font', [Client\AccountController::class, 'updateFont'])->name('api:client.account.update-font');
...
Route::group([
    ...
    Route::group(['prefix' => '/datapacks'], function () {
        ...
        Route::middleware('throttle:api.datapacks')
            ->post('/{datapack}/update', [Client\Servers\DatapackController::class, 'update']);
        Route::middleware('throttle:api.datapacks')
